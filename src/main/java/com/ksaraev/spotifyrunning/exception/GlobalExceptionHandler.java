...
import com.ksaraev.spotifyrunning.client.exception.SpotifyClientException;
import com.ksaraev.spotifyrunning.client.exception.http.SpotifyException;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleRuntimeException(RuntimeException e) {
    log.error("Spotify running application exception occurred", e);
