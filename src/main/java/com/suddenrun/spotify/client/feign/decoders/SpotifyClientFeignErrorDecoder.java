package com.suddenrun.spotify.client.feign.decoders;

import static com.suddenrun.spotify.client.exception.SpotifyClientDecodingErrorResponseIsNullException.*;

import com.suddenrun.spotify.client.exception.SpotifyClientDecodingErrorResponseIsNullException;
import com.suddenrun.spotify.client.feign.exception.FeignExceptionHandler;
import com.suddenrun.spotify.client.feign.exception.HandleFeignException;
import feign.Feign;
