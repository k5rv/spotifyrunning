package com.suddenrun.client.feign.decoders;

import static com.suddenrun.client.exception.SpotifyClientDecodingErrorResponseIsNullException.*;
...
import com.suddenrun.client.feign.exception.HandleFeignException;
import feign.Feign;
